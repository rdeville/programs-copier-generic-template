...
- ⚡️(tpl/base): Improve .yamlfmt with include and exclude files configuration
...
- ⚡️ Improve README.md template to be markdownlint compliant (!7)
...
- ✨(tpl/base): Add basic pre-commit configuration
